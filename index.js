...
client.on('ready', function() {
  ...
  client.user.setActivity(`🔮 Lilith.id V2 - ${client.user.username}`, { type: "Watching", url: 'https://www.twitch.tv/BotByBaronnetNoir' });
...
client.on('guildMemberAdd', async member => {
  ...
  let roleName = "Lilithien";
  let serveurID = "642420454698516490";
  let channelverif = client.channels.get("644491746939502613");
  let channelog = client.channels.get("645246582161276974");
...
channelverif.send(`Welcome to the server, <@${member.id}>!`, attachment).then(msg => {
